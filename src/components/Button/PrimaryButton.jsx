...
function PrimaryButton({
  ...
  const buttonClasses =
  "bg-[teal] hover:bg-[hoverTeal] GothamBold flex flex-row justify-center text-white font-bold py-3 px-8 rounded-full w-auto h-auto" +
  (className ? ` ${className}` : "") +
  (disabled || isLoading ? " disabled-class bg-gray-300" : "");
